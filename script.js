...
const collectEmployees = function () {
  ...
  while (true) {
    ...
    if (firstName && lastName && !isNaN(salary)) {
      ...
      const choice = confirm("Do you want to add another employee?");
      if (!choice) break;
    } else {
...
const getRandomEmployee = function (employeesArray) {
  ...
  const randomEm = Math.floor(Math.random() * employeesArray.length);
  const randomEmployee = employeesArray[randomEm];
